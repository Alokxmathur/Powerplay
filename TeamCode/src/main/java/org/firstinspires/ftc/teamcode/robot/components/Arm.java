...
public class Arm {
    ...
    public void setPositions(ArmOperation.Type type, ArmPosition position) {
        switch (type) {
            case Position: {
            ...
            case Compact: {
                setPositions(RobotConfig.ARM_COMPACT_POSITION);
                break;
            }
            case Release: {
                releaseWrist();
            ...
            case Mid: {
                setPositions(RobotConfig.ARM_MIDDLE_JUNCTION_POSITION);
                break;
            }
            case Low: {
                setPositions(RobotConfig.ARM_LOW_JUNCTION_POSITION);
            }
            default : {
