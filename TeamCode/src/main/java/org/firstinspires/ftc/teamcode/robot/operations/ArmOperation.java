...
public class ArmOperation extends Operation {
    ...
    public enum Type {
        Position, RaiseShoulder, LowerShoulder, RaiseElbow, LowerElbow, Compact, Release, Open, Close, Ground, Low, Mid, High,
        Pickup, InterimPickup, InterimDeposit, Stack5, Stack4, Stack3, Stack2, Stack1
    }
    Arm arm;
    Type type;
    ...
    public ArmOperation(Arm arm, Type type, ArmPosition position, String title) {
        this(arm, type, title);
    ...
    public void startOperation() {
        switch (this.type) {
            ...
            case Stack4:
            case Stack5: {
                arm.setPositions(type, position);
                break;
            }
            case Open: {
                arm.openClaw();
            ...
            case RaiseElbow: {
                arm.raiseElbowIncrementally();
                break;
            }
            case LowerElbow: {
                arm.lowerElbowIncrementally();
                break;
            }
            case RaiseShoulder: {
                arm.raiseShoulderIncrementally();
                break;
            }
            case LowerShoulder: {
                arm.lowerShoulderIncrementally();
                break;
            }
        }
    }
